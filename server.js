...
//mongoose connecting
mongoose.
connect('mongodb+srv://mean:Narxoz-mean2024@atlascluster.mdmzvd6.mongodb.net/?retryWrites=true&w=majority&appName=AtlasCluster')
.then(() => {
...
app.get('/weather/:city', async (req, res) => {
  try {
    ...
    console.error(error);
    res.status(404).json({ message: 'Error fetching weather data' });
  }
});
